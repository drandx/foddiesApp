...
export class HereMapComponent implements OnInit {
  ...
  onChangeLocation(map, lat, lng) {
    ...
    var routingParameters = {
      ...
      'waypoint0': 'geo!41.9373772,-87.7103178',
    ...
    const showResultsHandler = (result) => {
      var route,
        routeShape,
        startPoint,
        endPoint,
    ...
    router.calculateRoute(routingParameters, showResultsHandler,
      function (error) {
        alert(error.message);
      });
  }
  ...
  public ngAfterViewInit() {
    ...
    this.map = new H.Map(
      ...
      {
        zoom: 10,
        center: { lat: 41.885399, lng: -87.622341 }
      }
    );
    // this.onChangeLocation(this.map, '41.989378', '-87.6579677');
  }
